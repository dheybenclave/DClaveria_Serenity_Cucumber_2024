...
public class MealPage extends CommonPage {
    ...
    public WebElementFacade TXT_NAME() {return $(PARENT_HEADER + "//input[@id='mealsGridnew2name-awed']");}
    public WebElementFacade TXT_COMMENT() {return $(PARENT_HEADER + "//input[@id='mealsGridnew2Comments-awed']");}
